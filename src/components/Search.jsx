...
//
    const columns = [
        ...
        { field: 'Name', headerName: <BadgeIcon/> /*'الاسم'*/, width: 200 , 
            renderCell: (params) => (<div style={{  textAlign:'right' , fontWeight:'bold' ,fontSize:'30'}}>{params.value}</div>)},
        ...
        { field: 'NumberDays', headerName: 'عدد الأيام', width: 70 , 
            renderCell: (params) => (<div style={{  textAlign:'center',color:FTcolor }}>{params.value}</div>) },
        { field: 'AmountPaid', headerName: 'المدفوع', width: 90 ,
            renderCell: (params) => (<div style={{  textAlign:'center',color:FTcolor}}>{params.value}</div>)},
        { field: 'AmountOwed', headerName: 'المتبقي', width: 90 ,
            renderCell: (params) => (<div style={{  textAlign:'center',backgroundColor:'#E8F0FE', color: color(params.value) }}>{params.value}</div>)},
        { field: 'TypeDiseas', headerName: 'التحاليل', width: 130 ,
            renderCell: (params) => (<div style={{  textAlign:'right',backgroundColor:'#E8F0FE',color:FTcolor}}>{params.value}</div>)},
