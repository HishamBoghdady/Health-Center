export function CollectionDate1(entryTime, exitTime) {
    try {
...
// //////////////////////////////
export  function CollectionDate2(entryTime, exitTime) {
    try {
...
///////////////////////////////
export  function CollectionDate3(entryTime, exitTime) {
    try {
...
////////////////////////////////////////////////
export  function CollectionDate4(entryTime, exitTime) {
    try {
        const toSafeDate = (value) => {
            if (!value) return null;
...
////////////////////////////////
export  function CollectionDate5(entryTime, exitTime) {
    try {
...
export  function CollectionDateUniversal(entryTime, exitTime) {
  try {
...
export  function CollectionDateFirestore(entryTime, exitTime) {
  try {
    const toUTCDate = (value) => {
      if (!value) return null;
